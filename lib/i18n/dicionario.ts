...
export const DICIONARIO: Traducoes = {
  ...
  "Importar Leads": { es: "Importar leads" },
  "Faça upload de uma planilha (Excel ou CSV) contendo os leads. O sistema tentará localizar as colunas de \"Nome\" e \"Telefone/Celular\".": {
    es: "Sube una planilla (Excel o CSV) con los leads. El sistema intentará localizar las columnas de \"Nombre\" y \"Teléfono/Celular\".",
  },
  "Arquivo de Planilha": { es: "Archivo de planilla" },
  "Pré-visualização": { es: "Vista previa" },
  "encontrados": { es: "encontrados" },
  "(Sem nome)": { es: "(Sin nombre)" },
  "(Sem tel)": { es: "(Sin tel.)" },
  "E mais": { es: "Y más" },
  "Confirmar Importação": { es: "Confirmar importación" },
  "Falha ao ler o arquivo. Certifique-se de que é um Excel ou CSV válido.": {
    es: "No se pudo leer el archivo. Asegúrate de que sea un Excel o CSV válido.",
  },
  "Nenhum lead encontrado na planilha.": { es: "Ningún lead encontrado en la planilla." },
  "leads importados com sucesso!": { es: "leads importados con éxito!" },
  "Erro ao importar leads.": { es: "Error al importar leads." },
  "Erro desconhecido ao importar": { es: "Error desconocido al importar" },
